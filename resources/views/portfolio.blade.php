...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    <head>
      ...
      <footer id="footer">
        <div class="container">
          <h3>Shendy Dennison</h3>
          <p>Digital marketing isn't about marketing only</p>
          ...
          <div class="copyright">
            &copy; Copyright <strong><span>Shendy Dennison</span></strong>. All Rights Reserved
          </div>
        </div>
      </footer><!-- End Footer -->
